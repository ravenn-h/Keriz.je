...
exports.getTime = (format, date) => {
	if (date) {
		...
		return moment.tz('Africa/Abidjan').locale('id').format(format)
	}
}
...
exports.tanggal = (numer) => {
	myMonths = ["Janvier","FEVRIER","Mars","Avril","Mai","Juin","Juillet","AOUT","Septembre","Octobre","Novembre","Decembre"];
				myDays = ['Monday','Tuesday','Wednesday','Thursday','Friday','Satuday','Sunday']; 
				...
				const time = moment.tz('Africa/Abodjan').format('DD/MM HH:mm:ss')
				let d = new Date
				let locale = 'id'
				let gmt = new Date(0).getTime() - new Date('1 January 2000').getTime()
